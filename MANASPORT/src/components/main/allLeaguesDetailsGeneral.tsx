...
import EditMatchDayAllLeagues from "./editMatchdayAllLeagues";
//React Bootstrap
...
const AllLeaguesDetailsGeneral: React.FC<IProps & IpropsGlobal> = props => { //Function Component
  ...
  }, [count]); //When a hook value changes, the matchs on Redux are updated
  ...
  }, []); //When the value changes, the qualification is updated
            ...
            <div className="row justify-content-center">
              <div className="col-10">
                <Table responsive striped hover variant="dark" className="border border-secondary">
                  ...
                  <Tbody>
                    {props.matchs.map(m => (
                      <EditMatchDayAllLeagues key={m.MatchId} m={m} />
                    ))}
                  </Tbody>
                </Table>
              </div>
