...
const DeleteTeamModal: React.FC<IProps & IPropsGLobal> = ({ showModal, setShowModal, infoDeleteTeam, deleteTeamAction }) => {

  const deleteTeamAndClose = () => {
    deleteTeamAction(infoDeleteTeam.id);
    setShowModal(false)
  };
  ...
  return (
    ...
    >
      ...
      <Modal.Body className="bg-dark text-white">
        <BodyModal>
          <p>
            The tournament <span className="text-warning">'{infoDeleteTeam.name}'</span> and all your data
